      ...
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">
            Fakultas Universitas Muhammadiyah Magelang
          </h1>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              ...
              <a
                href="<?php echo base_url('fakultas/create');
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <div class="btn-group">
                          <a
                            href="<?php echo base_url('fakultas/edit/'.$row['fak_id']);
?>"
                          ...
                          <a
                            href="<?php echo base_url('fakultas/delete/'.$row['fak_id']);
?>"
